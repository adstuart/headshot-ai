...
2. **AI Processing**: The AI analyzes your photo and transforms it into a professional headshot while preserving your likeness
...
- Images are prepared client-side before being sent to reduce data transfer
- No photos are stored after processing
...
If you encounter any issues or have questions, open an issue on [GitHub](https://github.com/adstuart/headshot-ai/issues).
